...
class BiAttn(object):
    ...
    def build_graph(self, values, values_mask, keys, keys_mask):
        ...
        with vs.variable_scope("BiAttn"):
            ...
            H_tilde = tf.matmul(tf.expand_dims(b_dist, 1), keys) # matmul((batch_size, 1, N), (batch_size, N, 2h)) = (batch_size, 1, 2h)
...
class SelfAttn(object):
    ...
    def build_graph(self, values, values_mask, keys, keys_mask):
        ...
        with vs.variable_scope("Self-Attn"):
            ...
            V = oneway_encoder.build_graph(tf.concat([keys, U_tilde], axis=2), keys_mask) # (batch_size, N, 2h)
